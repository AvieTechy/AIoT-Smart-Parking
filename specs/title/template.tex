...
% Remove babel language option from documentclass to avoid missing vietnamese.ldf
...
\setlength{\parindent}{0pt} % Tắt indent đầu dòng
...
% Prefer polyglossia for XeLaTeX multilingual support (Vietnamese)
\usepackage{polyglossia}
\setdefaultlanguage{vietnamese}
% Set a common font with good Vietnamese coverage
...
% --- Việt hóa nhãn mục lục/chương (không phụ thuộc babel) ---
...
% Title
\rule{\linewidth}{0.2mm}\\[0.6cm] % Giảm độ dày line xuống 0.2mm
...
\setlength{\arrayrulewidth}{0.3pt} % Độ dày line trong bảng (giảm từ 0.8pt xuống 0.3pt)
\setlength{\doublerulesep}{1.5pt}  % Khoảng cách giữa 2 line kép
...
\setlength{\arrayrulewidth}{0.3pt} % Đồng bộ line mảnh cho bảng
\renewcommand{\arraystretch}{1.8}
\begin{tabular}{@{}c@{}}
\toprule
